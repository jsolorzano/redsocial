...
<head>
	...
	<script type="text/javascript" src="<?php echo assets_url('js/views.js');?>"></script>
</head>
<body>
	<header>
		<nav>
			<ul>
				<li>
					<a href="<?php echo base_url('profile'); ?>"><span class="menu-avatar"></span></a>
				</li>
				<li>
					<form action="#">
						<input type="text" placeholder="Buscar">
						<button>
							<img src="<?php echo assets_url('img/glasses.png');?>" height="10" alt="Buscar">
						</button>
					</form>
				</li>
				<li class="menu_option option"><a href="<?php echo base_url(); ?>">Datos</a></li>
				<li class="option"><a href="<?php echo base_url(); ?>">Perfil</a></li>
				<li class="option"><a href="<?php echo base_url(); ?>">Configuración</a></li>
			</ul>
		</nav>
	</header>
	<div class="container">
			...
			<section>
				<div class="avatar">
					<div class="background_image">
						<img src="<?php echo assets_url('img/avatar64.jpg');?>" alt="">
					</div>
					<div class="action">
						<h2><a href="<?php echo base_url('profile'); ?>">Benito Camelo Parado Al Fondo</a></h2>
		...
		<aside>
			...
			<div class="user_information">
				<div class="avatar">
					<span class="aside-avatar" style="background:url(<?php echo assets_url('img/avatar100.jpg');?>) center;"></span>
				</div>
	...
	<div class="background_modal" id="openmodal">
		<div class="modal_container">
			<a href="#close" class="close_button"><img src="<?php echo assets_url('img/close.png');?>" alt=""></a>
			<div class="modal_content">
				...
				<?php for ($i=0; $i < 15; $i++) { ?>
					<div class="comment">
						<div class="image">
							<img src="<?php echo assets_url('img/avatar64.jpg');?>" width="35" alt="Imagen">
						</div>
						<div class="text">
